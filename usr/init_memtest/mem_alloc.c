...
#define MM_MAXSIZEBITS     (MM_REQUIREDBITS + 5) ///< Max size of memory in allocator
...
errval_t initialize_ram_alloc(void)
{
    ...
    /* walk bootinfo looking for biggest RAM cap to use */
    ...
    printf("using region %d: %zd bits\n", mem_region, bi->regions[mem_region].mr_bits);
