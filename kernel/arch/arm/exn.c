 ...
 *
 * \param save_area Struct containing ARM registers.
 */
static void dump_arm_registers(arch_registers_state_t* save_area)
{
    printf("cpsr  = 0x%08"PRIx32"\t", save_area->named.cpsr);
    printf("r0    = 0x%08"PRIx32"\t", save_area->named.r0);
    printf("r1    = 0x%08"PRIx32"\t", save_area->named.r1);
    printf("r2    = 0x%08"PRIx32"\n", save_area->named.r2);
    printf("r3    = 0x%08"PRIx32"\t", save_area->named.r3);
    printf("r4    = 0x%08"PRIx32"\t", save_area->named.r4);
    printf("r5    = 0x%08"PRIx32"\t", save_area->named.r5);
    printf("r6    = 0x%08"PRIx32"\n", save_area->named.r6);
    printf("r7    = 0x%08"PRIx32"\t", save_area->named.r7);
    printf("r8    = 0x%08"PRIx32"\t", save_area->named.r8);
    printf("r9    = 0x%08"PRIx32"\t", save_area->named.rtls);
    printf("r10   = 0x%08"PRIx32"\n", save_area->named.r10);
    printf("r11   = 0x%08"PRIx32"\t", save_area->named.r11);
    printf("r12   = 0x%08"PRIx32"\n", save_area->named.r12);
    printf("stack = 0x%08"PRIx32"\n", save_area->named.stack);
    printf("link  = 0x%08"PRIx32"\n", save_area->named.link);
